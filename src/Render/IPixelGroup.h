...
public:
    ...
    virtual ProtoRGBColor* GetColor(unsigned int count) = 0;
    virtual ProtoRGBColor* GetColors() = 0;
    virtual ProtoRGBColor* GetColorBuffer() = 0;
    ...
    virtual BoundingBox2D& GetBounds() = 0;
