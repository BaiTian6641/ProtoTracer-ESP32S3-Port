...
private:
    SimpleMaterial baseMaterial = SimpleMaterial(ProtoRGBColor(255, 255, 255));
    Material* material = &baseMaterial;
    ProtoRGBColor white = ProtoRGBColor(255, 255, 255);
    ProtoRGBColor black = ProtoRGBColor(0, 0, 0);
    Vector2D size;
