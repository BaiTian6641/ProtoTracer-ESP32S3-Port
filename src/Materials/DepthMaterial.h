...
private:
    ProtoRGBColor spectrum[4] = {ProtoRGBColor(0, 255, 0), ProtoRGBColor(255, 0, 0), ProtoRGBColor(0, 255, 0), ProtoRGBColor(0, 0, 255)};
    GradientMaterial<2> gNoiseMat = GradientMaterial<2>(spectrum, 2.0f, false);
    Axis axis;
    float depth = 0.0f;
    float zOffset = 0.0f;
