...
public:
    ...
    static void Update(){
        ...
        for (int i = 0; i < FFTSize; ++i) {
            ...
            if (subtractedMag < 0.0f) subtractedMag = 0.0f; // Avoid negative magnitudes
        ...
        // Extract the real part as the time-domain signal
        //for (int i = 0; i < FFTSize; ++i) {
        //    inputStorage[i] = SampleArray[i * 2] / FFTSize; // Normalize if necessary
        //}
